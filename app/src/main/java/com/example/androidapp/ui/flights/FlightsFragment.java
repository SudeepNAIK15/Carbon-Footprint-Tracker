...
public class FlightsFragment extends Fragment {
    ...
    public View onCreateView(@NonNull LayoutInflater inflater,
        ...
        flightsViewModel.getSpinnerData().observe(getViewLifecycleOwner(), new Observer<List<String>>() {
            @Override
        ...
        flightsViewModel.getText().observe(getViewLifecycleOwner(), new Observer<String>() {
            @Override
        ...
        flightsViewModel.getAll().observe(getViewLifecycleOwner(), new Observer<List<CarbonEmissions>>() {
            @Override
